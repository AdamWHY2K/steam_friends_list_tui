...
public class SpectreConsoleDisplayManager : IFriendsDisplayManager
{
    ...
    private readonly DisplayTimerManager _timerManager;
    ...
    public SpectreConsoleDisplayManager(AppState appState, ILogger? logger = null)
    {
        ...
        // Create timer manager for refresh logic
        _timerManager = new DisplayTimerManager(
            appState,
            _logger,
            () => _stateManager.GetCurrentFriends(),
            () => RefreshDisplay());
